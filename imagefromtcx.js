...
this.getImageFromTCX = function(inputfilename, callback, error, ride) {
    ...
    var outfilename = path.join(__dirname, "images", path.basename(inputfilename, "tcx")+"png");
    ...
    this.onImageSaved = function (ride, outfilename) {
...
if (require.main === module) {
    ...
    filename = "data/2017-05-27_Cycling (1).tcx";
    //filename = "data/2017-06-02_Cycling (1).tcx";
    //filename = "data/2017-06-02_Cycling.tcx";
    //filename = "data/2017-05-31_Cycling.tcx"; 
    //filename = "data/2017-05-03_Afternoon ride_Cycling.tcx"; 
    //filename = "data/2017-05-01_Morning ride_Cycling.tcx"; 
    var oStretchMaps= new stretchMaps();
    oStretchMaps.getImageFromTCXfile(filename);
    //gu.tcxParseFile(filename, getImageFromTCX.bind(this, filename, onImageSaved));
    
    //gu.tcxParseFile(filename, getImageFromTCX.bind(this, filename, onImageSaved));
    
   /*cant call twice because of 
   /home/ubuntu/workspace/node_modules/leaflet-headless/node_modules/leaflet/dist/leaflet-src.js:3286
